...
const MintNft: FC = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setUploading(false);
      await handleMint(cid, file.name);
    } catch (err) {
      alert(err);
      setUploading(false);
    }
  ...
  return (
    <main>
      <button
        type="button"
        className={`mr-4 border border-gray-300 text-gray-50 focus:outline-none rounded px-8 py-2 text-center font-semibold ${
          !address && "hover:bg-lime-700"
      ...
      {address && (
        <>
          <button
            type="button"
            className="mr-4 border border-gray-300 text-gray-50 hover:bg-lime-700 focus:outline-none rounded px-8 py-2 text-center font-semibold"
                ...
                <div className="relative bg-gray-800 rounded-lg shadow">
                  ...
                  <div className="px-6 py-6 lg:px-8">
                    ...
                    <section className="space-y-6">
                      ...
                      <button
                        className="w-full text-white focus:outline-none font-semibold rounded text-md px-5 py-2.5 text-center bg-gradient-to-r from-lime-600 to-green-700 hover:bg-none hover:bg-lime-600"
